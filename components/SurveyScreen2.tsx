...
export default function SurveyScreen2({ onNext, onBack, onSkip }: SurveyScreenProps) {
  return (
    <View className="flex-1 justify-start items-center px-8 pt-16">
      ...
      <View className="w-full h-2 bg-white/20 rounded-full mb-12">
        <View className="h-full w-[20%] bg-blue-500 rounded-full" />
      </View>
      ...
      <View className="w-24 h-24 mb-10 items-center justify-center bg-blue-500/20 rounded-full">
        <Svg width="48" height="48" viewBox="0 0 24 24" fill="none">
          <Path 
            d="M12 15.5V8.5M7 10.5L12 5.5L17 10.5" 
            stroke="#60a5fa" 
            strokeWidth="2" 
            strokeLinecap="round" 
            strokeLinejoin="round" 
      ...
      <View className="w-full">
        <TouchableOpacity 
          ...
          onPress={onNext}
        >
          <Text className="text-white text-lg">I want to quit vaping</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={onNext}
        >
          <Text className="text-white text-lg">I want to better understand my habit</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={onNext}
        >
          <Text className="text-white text-lg">I'm not sure</Text>
        </TouchableOpacity>
      </View>
